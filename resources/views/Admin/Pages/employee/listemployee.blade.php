            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  <td>{{$i}}</td>
                  <td>{{$employee->name}}</td>
                  <td><img width="100px" height="100px" src="{{url($employee->image)}}"></td>
                  <td>{{$employee->status == 1 ? "Hiện" : "Ẩn"}}</td>
                  <td>{{$employee->position}}</td>
                  <td>{{$employee->description}}</td>
                  <td class=" py-0 align-middle">
                    <div class="btn-group btn-group-sm">
                      <a href="{{route('employee.edit',$employee->id)}}"><i class="btn btn-info far fa-edit"></i></a>
