...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <!-- SEARCH FORM -->
    <form class="form-inline ml-3" action="{{route('searchlocation')}} " method="POST">
				@csrf
				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-right py-0 align-middle">
								<div class="btn-group btn-group-sm">
									<a onclick="return confirm('Are you sure you want to delete?')" href="admin/deletelocation/{{$location->location_id}}" class="btn btn-danger"><i class="fas fa-trash"></i></a>
								</div>
							</td>
							@php
							$i++;							@endphp
