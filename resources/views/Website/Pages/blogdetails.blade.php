...
@section('content')
    ...
    style="background-image: url('../../public/uploads/banner/{{$banner->image}}');">
            ...
            @foreach($blog_details as $blogdetail)
                        ...
                        <div class="col-lg-8">
                            <div class="post-details">
                                <div class="entry-header">
                                    ...
                                    <img src="{{url("public/uploads/blog/$blogdetail->image")}}" alt="Image">
                                    </div>
                                    <ul class="entry-meta list-inline">
                                    <li><a href="single-blog.html"><i class="far fa-user-alt"></i>{{$blogdetail->meta_title}}</a></li>
                                    {{-- <li><a href="single-blog.html"><i class="far fa-calendar-alt"></i>{{$blogdetail->meta_descript}}</a> --}}
                                        </li>
                                    </ul>
                                    <h2 class="entry-title"> {{$blogdetail->summary}} </h2>
                                </div>
